    ...
    <section id="team" className="section">
      <div className="container mx-auto text-center">
        ...
        <p className="max-w-[540px] mx-auto px-6 lg:px-0 mb-[60px]">
          ...
          sunt sapiente! Inventore, soluta dolores. Quo corrupti debitis commodi
          voluptatibus earum aliquid tempore consectetur fugiat consequuntur
          ipsa ex quas, quia officiis?
        </p>
        {/* team member */}
