...
const Skills = () => {
  return (
    <section id="skills" className="section bg-[#f8f3e] pb-32">
      <div className="container mx-auto text-center">
        ...
        <p className="max-w-[540px] mx-auto px-6 lg:px-0 mb-[60px]">
          ...
          suscipit consequuntur officia tempora odit, adipisci quibusdam dolore
          vero laudantium error provident nulla incidunt laborum, accusamus,
          unde ipsam esse ratione!
        </p>
        {/* skills grid */}
          ...
          {skills.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <h4 className="text-2xl mb-2 font-primary font-body">
                  {title}
                </h4>
